...
void ATESTCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Restart", IE_Pressed, this, &ATESTCharacter::CallRestartPlayer);
}
...
void ATESTCharacter::Destroyed()
{
	Super::Destroyed();
}


void ATESTCharacter::CallRestartPlayer()
{
	...
	{
		if (ATESTGameMode* GameMode = Cast<ATESTGameMode>(World->GetAuthGameMode()))
		{
